...
const VerifyEmailPage = () => {
  ...
  const handleVerify = async () => {
    ...
    try {
      console.log('[Verify] OTP valid, registering admin user');
      ...
      let errorMessage = 'We could not complete the registration. Please try again.';
      ...
      <div className="max-w-md w-full border border-white/20 bg-white/10 backdrop-blur-lg rounded-2xl p-8 space-y-6">
        <div className="space-y-2 text-center">
          ...
          <p className="text-sm text-white/70">
            {pending
              ? `We sent a code to ${pending.email}. Enter it below to finish setting up your admin account.`
