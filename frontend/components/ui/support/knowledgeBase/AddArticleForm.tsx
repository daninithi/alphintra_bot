...
export default function AddArticleForm({ onAddArticle }: AddArticleFormProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    onAddArticle({
      ...formData,
      id: `KB${(Math.floor(Math.random() * 1000) + 1).toString().padStart(3, '0')}`,
  ...
  return (
    <DialogContent className="max-w-2xl">
      <DialogHeader>
        <DialogTitle className="text-black dark:text-white">Add New Article</DialogTitle>
      </DialogHeader>
      <DialogClose
        ref={closeButtonRef}
